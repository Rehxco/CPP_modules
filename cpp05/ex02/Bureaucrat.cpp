...
/*   Updated: 2026/07/14 14:48:17 by sbrochar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::executeForm(AForm const &form)
{
	...
	{
		form.execute(*this);
		std::cout << name << " executed " << form.getName_Form() << std::endl;
	}
	catch (std::exception &e)
	{
		std::cout << name << " couldn’t executed " << form.getName_Form() << " because " << e.what() << std::endl;
	}
} 